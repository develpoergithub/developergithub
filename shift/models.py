...
class Shift(models.Model):
    ...
    posted_by = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name="posted_by_set", null=False, on_delete=models.CASCADE)
    # The Company that this Shift is posted on
    posted_to = models.ForeignKey(
        settings.AUTH_USER_MODEL, related_name="posted_to_set", null=False, on_delete=models.CASCADE)
